...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    if (imageKey) {
        ...
        [[BNRImageStore sharedImageStore] imageForKey:imageKey];
...
- (IBAction)takePicture:(id)sender 
{
    ...
    if (oldKey) {
        ...
        [[BNRImageStore sharedImageStore] deleteImageForKey:oldKey];
    }
...
didFinishPickingMediaWithInfo:(NSDictionary *)info
{
    ...
    [[BNRImageStore sharedImageStore] setImage:image
